...
LUALIB_API int luaopen_lprotobuf_io(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_lprotobuf_conv(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_lprotobuf_buffer(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_lprotobuf_slice(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_lprotobuf(lua_State *L) {
    luaL_Reg libs[] = {
        { "pack",     Lbuf_pack     },
...
LUALIB_API int luaopen_lprotobuf_unsafe(lua_State *L) {
    luaL_Reg libs[] = {
